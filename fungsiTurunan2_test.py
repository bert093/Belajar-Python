...
#* Derivative(expr1, x): Membuat representasi simbolik dari turunan fungsi expr1 terhadap variabel x.
#* .doit(): Memerintahkan SymPy untuk "menghitung" turunan simbolik menjadi hasilnya.
